...
SELECT
--a.guid,
COUNT(DISTINCT CASE WHEN a.min_visit_date <= b.subscription_start_date THEN a.guid END) AS first_visit_b4_any_purchase,
COUNT(DISTINCT CASE WHEN a.min_visit_date <= b.min_subscription_start_date THEN a.guid END) AS first_visit_b4_first_purchase,
COUNT(DISTINCT CASE WHEN a.visit_date <= b.subscription_start_date THEN a.guid END) AS any_visit_b4_any_purchase,
COUNT(DISTINCT CASE WHEN a.visit_date <= b.min_subscription_start_date THEN a.guid END) AS any_visit_b4_first_purchase,
FROM adobe AS a
INNER JOIN ssp AS b
